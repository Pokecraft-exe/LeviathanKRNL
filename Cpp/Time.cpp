...
{
    printf(IntToStr(time->century)); // y-m-d <> h-m-s
    printf(IntToStr(time->year));
    printf("-");
    printf(IntToStr(time->month));
    printf("-");
    printf(IntToStr(time->monthday));
    printf(" <> ");

    printf(IntToStr(time->hour+TIME_ZONE));
    printf(":");
    printf(IntToStr(time->minutes));
    printf(":");
    printf(IntToStr(time->seconds));
    printf("   ");
