...
x86_64-elf-gcc -ffreestanding -mno-red-zone -mgeneral-regs-only -m64 -c "Cpp/IDT.cpp" -o "Cpp/IDT.o"
...
x86_64-elf-gcc -ffreestanding -mno-red-zone -m64 -c "Cpp/2D.cpp" -o "Cpp/2D.o"
